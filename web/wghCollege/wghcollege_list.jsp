...
<table border="1">
	...
	<c:forEach items="${list}" var="wghcollege"  varStatus="status" >
		<tr>
			...
			<td>
				<a href="${pageContext.request.contextPath}/wghcollegeDelete?id=${wghcollege.wgh_id}">删除</a>
				&nbsp;|&nbsp;
				<a href="${pageContext.request.contextPath}/wghcollegeInfo?id=${wghcollege.wgh_id}">修改</a>
			</td>
		</tr>
