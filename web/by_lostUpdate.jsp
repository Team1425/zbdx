...
<h2>修改失物信息</h2>
<hr/>
<form action="${pageContext.request.contextPath}/by_lostUpdate" method="POST">
    ...
    <table border="1">
        <tr>
            <td width="30%">物品种类</td>
            <td>
                <input type="text" name="name" value="${lost.type}"/>
            </td>
        </tr>
        <tr>
            <td>物品特征</td>
            <td>
                <input type="text" name="trait" value="${lost.trait}"/>
            </td>
        </tr>
        <tr>
            <td>录入时间</td>
            <td>
                <input type="text" name="time" value="${lost.time}"/>
            </td>
        </tr>
        <tr>
            <td>丢失地点</td>
            <td>
                <input type="text" name="lost_loc" value="${lost.lost_loc}"/>
            </td>
        </tr>
        <tr>
            <td>领取地点</td>
            <td>
                <input type="text" name="get_loc" value="${lost.get_loc}"/>
            </td>
        </tr>
