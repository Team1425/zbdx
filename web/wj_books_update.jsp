...
<h2>修改图书信息</h2>
<hr/>
<form action="${pageContext.request.contextPath}/booksUpdate" method="POST">
    <input type="hidden" name="id" value="${wjbooks.id}"/>
    <table border="1">
        <tr>
            <td width="30%">书名</td>
            <td>
                <input type="text" name="booksname" value="${wjbooks.booksname}"/>
            </td>
        </tr>
        <tr>
            <td>作者</td>
            <td>
                <input type="text" name="author" value="${wjbooks.author}"/>
            </td>
        </tr>
        ...
        <tr>
            <td>ISBN</td>
            <td>
                <input type="text" name="ISBN" value="${wjbooks.ISBN}"/>
            </td>
        </tr>
        ...
        <tr>
            <td>出版社</td>
            <td>
                <input type="text" name="ph" value="${wjbooks.ph}"/>
            </td>
        </tr>
        ...
        <tr>
            <td>价格</td>
            <td>
                <input type="text" name="price" value="${wjbooks.price}"/>
            </td>
        </tr>
        ...
        <tr>
            <td>出版日期</td>
            <td>
                <input type="text" name="pd" value="${wjbooks.pd}"/>
            </td>
        </tr>
