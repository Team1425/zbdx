...
<form action="doorUpdate" method="POST">
	...
	<table border="1">
		<tr>
			<td width="30%">宿舍楼</td>
			<td>
				<input type="text" name="addr" value="${dorm.addr}"/>
			</td>
		</tr>
		<tr>
			<td>宿舍号</td>
			<td>
				<input type="text" name="id" value="${dorm.id}"/>
			</td>
		</tr>
		<tr>
			<td>舍长姓名</td>
			<td>
				<input type="text" name="name1" value="${dorm.name1}"/>
			</td>
		</tr>
		<tr>
			<td>舍长学号</td>
			<td>
				<input type="text" name="stu_id" value="${dorm.stu_id}"/>
			</td>
		</tr>
		<tr>
			<td>联系电话</td>
			<td>
				<input type="text" name="stu_tel" value="${dorm.stu_tel}"/>
			</td>
		</tr>
		<tr>
			<td>宿舍成员1</td>
			<td>
				<input type="text" name="name2" value="${dorm.name2}"/>
			</td>
		</tr>
		<tr>
			<td>宿舍成员2</td>
			<td>
				<input type="text" name="name3" value="${dorm.name3}"/>
			</td>
		</tr>
		<tr>
			<td>宿舍成员3</td>
			<td>
				<input type="text" name="name4" value="${dorm.name4}"/>
			</td>
		</tr>
		<tr>
			<td colspan="2">
